...
class AddressRepoTest {
    ...
    void findAddressByAccount() {
        ...
        Address address1 = new Address(account, "testAddress1", "testCity1", "MI", 12345, false, "Zach", "Warunek");
        Address address2 = new Address(account, "testAddress2", "testCity2", "MI", 12345, false, "Zach", "Warunek");
    ...
    void deleteAllByAccount() {
        ...
        Address address1 = new Address(account, "testAddress1", "testCity1", "MI", 12345, false, "Zach", "Warunek");
        Address address2 = new Address(account, "testAddress2", "testCity2", "MI", 12345, false, "Zach", "Warunek");
        Address address3 = new Address(account, "testAddress3", "testCity2", "MI", 12345, false, "Zach", "Warunek");
    ...
    void setAsFavorite() {
        ...
        Account account = new Account("Zach",
                                      ...
                                      AccountRole.ROLE_USER);
        accountRepo.save(account);
        Address address1 = new Address(account, "testAddress1", "testCity1", "MI", 12345, true, "Zach", "Warunek");
        Address address2 = new Address(account, "testAddress2", "testCity2", "MI", 12345, false, "Zach", "Warunek");
        Address address3 = new Address(account, "testAddress3", "testCity2", "MI", 12345, false, "Zach", "Warunek");
